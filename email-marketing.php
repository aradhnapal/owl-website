...
$current_service = "EMAIL MARKETING";
?>
            ...
            <div class="col-xxl-8 col-xl-8 col-lg-8">
                <div class="service-details-content mb-50">
                    <div class="service-details-main-img img-cover">
                        <img src="assets/img/services/sd-img-1.jpg" alt="EMAIL MARKETING">
                    </div>
                    <h2 class="chy-heading-1 service-details-title chy-split-in-right chy-split-text">EMAIL MARKETING</h2>
                    <p class="chy-para-1 inner-page-disc">
                        This is the EMAIL MARKETING service detail page. Add your email marketing service description here.
                    </p>
                </div>
            </div>
            <!-- sidebar -->
